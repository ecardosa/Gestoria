...
<template>
    <div class="bg-gray-100">
        ...
        <div class="flex items-center justify-between">
            ...
            <button class="btn btn-outline mr-10" @click="showModalConcept()" v-if="$page.props.user.is_admin">
                Afegir concepte
            </button>
        </div>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th v-if="$page.props.user.is_admin">Accions</th>
                    </tr>
                </thead>
                <tbody>
                    <tr v-for="concept in $page.props.concepts" :key="concept.id">
                        ...
                        <td v-if="$page.props.user.is_admin" class="flex justify-end">
